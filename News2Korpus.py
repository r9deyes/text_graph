...
class News2Korpus:
    ...
    def machNewsKorp(self):
        ...
        if isinstance(self.gruppe,str):
            resp, count, first, last, name = ng.group(self.gruppe)
        elif isinstance(self.gruppe,int):
            resp,groups=ng.newgroups('720101','000000')
            resp, count, first, last, name = ng.group(groups[self.gruppe])
...
if __name__ == '__main__':
    server = 'news.caravan.ru'#'news.dzug.org'
    gruppe = 17#'de.comp.dzug.cmf'
